  ...
  return (
    ...
    relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex h-[340px] w-full items-start justify-start gap-8 overflow-x-auto lg:h-[400px] xl:h-[640px]">
        ...
        subtitle="Esteen, Pasuruan"
        peopleJoined= "20+ Joined"
        />
      </div>

      <div className="flexEnd mt-10 px-6 lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 lg:max-w-[500px] xl:max-w-[734px] xl:px-16 xl:py-20 relative w-full overflow-hidden rounded-2xl">
          <h2 className="text-white regular-24 md:regular-32 2xl:regular-64 capitalize"><strong>Feeling Lost</strong> and not Knowing The Way?</h2>
