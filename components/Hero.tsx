...
const Hero = () => {
  return (
    <header className="max-container padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
            ...
            <div className="my-11 flex flex-wrap gap-5">
                <div className="flex items-center gap-1">
                    {Array(5).fill(1).map((_, index) => {
                        return (
                            <Image src="/star.svg" key={index} alt="star rating" width={24} height={24} />
                        )
                    } )}
                </div>
            ...
            <div className="relative z-20 w-[268px] flex flex-col gap-8 rounded-3xl bg-green-90 px-7 py-8">
                ...
                <div className="flexBetween">
                    <div className="flex flex-col">
                        ...
                        <p className="bold-20 text-white">173.2 miles</p>
                    </div>
                    <div className="flex flex-col">
